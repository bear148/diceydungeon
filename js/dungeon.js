...
export const dungeon_structs = {
    ...
    fury_cave: {
        name: "Fury Cave",
        enemies: [
            new Enemy("Brainlet", 75, 2, 0, 1, "/assets/enemy.png", 55),
            new Enemy("Plughead", 75, 2, 0, 1, "/assets/goblin.png", 55),
            new Enemy("Molecule Brain", 65, 2, 0, 1, "/assets/enemy2.png", 80),
            new Enemy("Plughead", 100, 2, 0, 1, "/assets/goblin.png", 100),
            new Enemy("Brainlet", 75, 2, 0, 1, "/assets/enemy.png", 70),
            new Enemy("Nether Head", 75, 2, 0, 1, "/assets/Nether.png", 60),
            new Enemy("Molecule Brain", 65, 2, 0, 1, "/assets/enemy2.png", 80),
            new Enemy("Plughead", 100, 2, 0, 1, "/assets/goblin.png", 100),
            new Enemy("Skeleton", 400, 4, 2, 3, "/assets/skeleton.png", 250, true),
            new Enemy("Wind Up", 600, 4, 2, 3, "/assets/windup.png", 500, true),
        ],
    },
    forsaken_island: {
